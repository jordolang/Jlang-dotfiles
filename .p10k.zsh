# Generated by Powerlevel10k configuration wizard on 2026-02-04 at 04:20 EST.
...
() {
  ...
  #################################[ os_icon: os identifier ]##################################
  # OS identifier color (white on blue).
  ...
  # REPOS - Lime green background for coding projects
  typeset -g POWERLEVEL9K_DIR_REPOS_VISUAL_IDENTIFIER_EXPANSION=' '
  typeset -g POWERLEVEL9K_DIR_REPOS_BACKGROUND=22
  typeset -g POWERLEVEL9K_DIR_REPOS_FOREGROUND=255
  typeset -g POWERLEVEL9K_DIR_REPOS_SHORTENED_FOREGROUND=250
  typeset -g POWERLEVEL9K_DIR_REPOS_ANCHOR_FOREGROUND=255
  typeset -g POWERLEVEL9K_DIR_REPOS_NOT_WRITABLE_VISUAL_IDENTIFIER_EXPANSION=' '

  # DOWNLOADS - Orange
  typeset -g POWERLEVEL9K_DIR_DOWNLOADS_VISUAL_IDENTIFIER_EXPANSION=' '
  typeset -g POWERLEVEL9K_DIR_DOWNLOADS_BACKGROUND=208
  typeset -g POWERLEVEL9K_DIR_DOWNLOADS_FOREGROUND=0

  # DOCUMENTS - Blue
  typeset -g POWERLEVEL9K_DIR_DOCUMENTS_VISUAL_IDENTIFIER_EXPANSION='󰈙 '
  typeset -g POWERLEVEL9K_DIR_DOCUMENTS_BACKGROUND=33
  typeset -g POWERLEVEL9K_DIR_DOCUMENTS_FOREGROUND=255

  # DESKTOP - Yellow
  typeset -g POWERLEVEL9K_DIR_DESKTOP_VISUAL_IDENTIFIER_EXPANSION=' '
  typeset -g POWERLEVEL9K_DIR_DESKTOP_BACKGROUND=220
  typeset -g POWERLEVEL9K_DIR_DESKTOP_FOREGROUND=0

  # CONFIG - Red
  typeset -g POWERLEVEL9K_DIR_CONFIG_VISUAL_IDENTIFIER_EXPANSION=' '
  typeset -g POWERLEVEL9K_DIR_CONFIG_BACKGROUND=124
  typeset -g POWERLEVEL9K_DIR_CONFIG_FOREGROUND=255
  ...
  typeset -g POWERLEVEL9K_DIR_ETC_FOREGROUND=250
  ...
  typeset -g POWERLEVEL9K_VCS_CLEAN_BACKGROUND=22         # dark green
  typeset -g POWERLEVEL9K_VCS_MODIFIED_BACKGROUND=208      # orange
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_BACKGROUND=33      # blue
  typeset -g POWERLEVEL9K_VCS_CONFLICTED_BACKGROUND=196    # red
  typeset -g POWERLEVEL9K_VCS_LOADING_BACKGROUND=238       # gray
  ...
  function my_git_formatter() {
    ...
    local conflicted='%11F' # bright yellow foreground
  ...
  ###################[ command_execution_time: duration of the last command ]###################
  # Execution time color (orange background).
  ...
  ######################################[ ram: free RAM ]#######################################
  # RAM color (lime green).
  typeset -g POWERLEVEL9K_RAM_FOREGROUND=0
  typeset -g POWERLEVEL9K_RAM_BACKGROUND=118
  # Custom icon.
  ...
  # Context color when running with privileges (red - warning).
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_FOREGROUND=255
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_BACKGROUND=196
  # Context color in SSH without privileges (orange - alert).
  ...
  # Python virtual environment color (yellow).
  ...
  typeset -g POWERLEVEL9K_NVM_BACKGROUND=118
  ...
  ##############################[ node_version: node.js version ]###############################
  # Node version color (green).
  typeset -g POWERLEVEL9K_NODE_VERSION_FOREGROUND=0
  typeset -g POWERLEVEL9K_NODE_VERSION_BACKGROUND=118
  ...
  typeset -g POWERLEVEL9K_PACKAGE_BACKGROUND=196
  ...
  ###############################[ public_ip: public IP address ]###############################
  # Public IP color (red background).
  typeset -g POWERLEVEL9K_PUBLIC_IP_FOREGROUND=255
  typeset -g POWERLEVEL9K_PUBLIC_IP_BACKGROUND=124
  # Custom icon.
  ...
  # IP color (deep blue).
  typeset -g POWERLEVEL9K_IP_BACKGROUND=25
  ...
  ####################################[ time: current time ]####################################
  # Current time color (blue background).
